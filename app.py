...
pyautogui.PAUSE = 0.5
interrompido = False  # Variável global para indicar se o processo foi interrompido
...
def enviar_convites(contador, convites, interrompido):
...
def main():
  ...
  enviar_convites(contador, convites, interrompido)
